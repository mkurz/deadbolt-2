...
h1.30 November 2012 - Important!  Deadbolt 2 is currently undergoing a redesign to ensure it offers full support for both Java and Scala.  For the next few days, changes in the API,including package names and method signatures are likely.
